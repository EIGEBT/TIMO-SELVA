...
ControllerAll = false
local ListSudos ={Sudo_Id,1965534755,1804133252,5083074447}  
...
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5083074447 then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/CH_Timo'}, },}}
...
{
{text = Jabwa, url = 't.me/CH_Timo'}, 
},
{
{text = Grosupsw, url = 't.me/CH_Timo'}, 
},
{
{text = Usperos, url = 't.me/CH_Timo'}, 
},
}
...
data = {
{
{text = '𓄼• sᴏᴜʀᴄᴇ sᴀɪᴅɪ •𓄹', url = 't.me/CH_Timo'}, 
},
}
}
...
keyboard.inline_keyboard = {
{
{text = ban.first_name, url = 't.me/CH_Timo'}, 
},
}
local msgg = msg_id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = UserInfo.first_name, url = 't.me/CH_Timo'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𓄼• 𝗝ٰٖ𝗔ٰٖ𝗕ٰٖ𝗪ٰٖ𝗔ٰٖ •𓄹', url = "https://t.me/J_A_B_W_A"},{text = '𓄼• ٰٖ𝗝ٰٖ𝗘ٰٖ𝗞ٰٖ𝗔ٰٖ •𓄹', url = "https://t.me/Dev_Jeka"}
},
{
{text = '𓄼• ٰٖ𝗕ٰٖ𝗔ٰٖ𝗡ٰٖ𝗗ٰٖ𝗔ٰٖ •𓄹', url = "https://t.me/Q_o_ll"}
},
{
{text = '𓄼• 𝗦ِٰٰٰٰٰٰٰٰ𝗢ِٰ𝗨ِٰ𝗥ِٰ𝗖ِٰ𝗘ٰٰٰٰٰٰٰٰٰٰٰٰٰ ٰ𝗦ِٰ𝗔ِٰ𝗜ِٰ𝗗ِٰ𝗜ٰ •𓄹', url = "https://t.me/CH_Timo"}
},
}
local msgg = msg_id/2097152/0.5
...
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴊᴇᴋᴀ \nᴛᴏ ᴄᴏᴍᴍ𝗎ɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙ𝗎ᴛᴛᴏɴѕ ʟᴏᴡᴇʀ • '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼⦁ 𝗝ٰٖ𝗘ٰٖ𝗞ٰٖ𝗔ٰٖ ➪🇳🇱⦁𓄹', url = "https://t.me/Dev_Jeka"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
