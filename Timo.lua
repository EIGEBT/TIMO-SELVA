...
ControllerAll = false
local ListSudos ={Sudo_Id,5217455708,1825532106}  
...
LuaTele.editMessageText(ChatId,MsgId,"*𓄼๏𓄹 صلاحيات الادمن*", 'md', false, false, reply_markupp)
end
...
{
{text = '𓄼๏𓄹 اخفاء الامر 𓄼๏𓄹', data =IdUser..'/'.. '/delAmr'}
},
}
}
LuaTele.editMessageText(ChatId,MsgId," 𓄼๏𓄹 صلاحيات الجروب - ", 'md', false, false, reply_markup)
end
...
return {
Lock     = '\n* 𓄼๏𓄹 بواسطه ⇦ *'..banusername..'\n*'..TextMsg..'\n 𓄼๏𓄹 خاصيه المسح *',
unLock   = '\n* 𓄼๏𓄹 بواسطه ⇦ *'..banusername..'\n'..TextMsg,
lockKtm  = '\n* 𓄼๏𓄹 بواسطه ⇦ *'..banusername..'\n*'..TextMsg..'\n 𓄼๏𓄹 خاصيه الكتم *',
lockKid  = '\n* 𓄼๏𓄹 بواسطه ⇦ *'..banusername..'\n*'..TextMsg..'\n 𓄼๏𓄹 خاصيه التقييد *',
lockKick = '\n* 𓄼๏𓄹 بواسطه ⇦ *'..banusername..'\n*'..TextMsg..'\n 𓄼๏𓄹 خاصيه الطرد *',
Reply    = '\n* 𓄼๏𓄹 المستخدم ⇦ *'..banusername..'\n*'..TextMsg..'*'
}
end
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 اطلق دخول ['..ban.first_name..'](tg://user?id='..msg.sender.user_id..')\n 𓄼๏𓄹 نورت الجروب {'..Get_Chat.title..'}',"md")  
end
end
end
...
if type == "kick" then 
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 قام بالتكرار في الجروب وتم طرده").Reply,"md",true)
end
if type == "del" then 
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if type == "keed" then
return LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0}), LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 قام بالتكرار في الجروب وتم تقييده").Reply,"md",true)  
end
if type == "mute" then
Redis:sadd(Timo.."Timo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لا استطيع تثبيت الرسائل ليست لديه صلاحيه","md",true)
end
end
local UnPin = LuaTele.unpinChatMessage(msg_chat_id) 
if UnPin.luatele ~= "ok" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لا استطيع الغاء تثبيت الرسائل ليست لديه صلاحيه","md",true)
end
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 التثبيت معطل من قبل المدراء ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا استطيع تغيير صوره الجروب لاني لست ادمن او ليست لديه الصلاحيه *","md",true)    
end
Redis:del(Timo.."Timo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تغيير صوره الجروب الجروب *","md",true)    
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 ارسل تحذير𓄼 "..Filters.." 𓄹عند ارساله*","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 تم اضافه رد التحذير*","md",true)  
end
...
Redis:del(Timo..'Timo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم الغاء منع𓄼 "..Filters.."𓄹*","md",true)  
end
end
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لقد تم منع هذه𓄼 "..statusfilter.."𓄹هنا*\n 𓄼๏𓄹 "..ReplyFilters,"md",true)   
end
end
...
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم ازالة هاذا ⇦ 𓄼 "..text.."𓄹*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد امر بهاذا الاسم*","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ الامر باسم ⇦𓄼 "..text..' 𓄹*',"md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم الغاء حفظ الرابط*","md",true)         
end
...
Redis:del(Timo.."Timo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ الرابط بنجاح*","md",true)         
end
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(Timo.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Timo.."Timo:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ ترحيب الجروب*","md",true)     
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(Timo.."Timo:Group:Rules" .. msg_chat_id,text) 
Redis:del(Timo.."Timo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ قوانين الجروب*","md",true)  
end  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم الغاء حفظ وصف الجروب*","md",true)   
end 
LuaTele.setChatDescription(msg_chat_id,text) 
Redis:del(Timo.."Timo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ وصف الجروب*","md",true)  
end  
if text  then
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ في قائمه الردود *\n* 𓄼๏𓄹 ارسل𓄼"..test.."𓄹لرئية الرد*","md",true)  
end  
end
...
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
𓄼๏𓄹 ارسل الان الكلمه لاضافتها في الردود
...
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
...
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حفظ الرد العام *\n* 𓄼๏𓄹 ارسل𓄼"..test.."𓄹لرئية الرد*","md",true)  
return false
end  
end
if text and text:match("^(.*)$") then
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حذف الرد في الردود العامه *","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*𓄼๏𓄹 تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Timo.."Timo:Num:User:Pv") 
LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 تم التوجيه الى 𓄼"..#list.."𓄹 مشترك ف البوت *","md",true)      
for k,v in pairs(list) do  
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*𓄼๏𓄹 تم الغاء الاذاعه للخاص*","md",true)  
end 
local list = Redis:smembers(Timo.."Timo:Num:User:Pv") 
...
LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 تمت الاذاعه الى 𓄼"..#list.."𓄹 عضو في البوت *","md",true)      
Redis:del(Timo.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false
end
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*𓄼๏𓄹 تم الغاء الاذاعه للمجموعات*","md",true)  
end 
local list = Redis:smembers(Timo.."Timo:ChekBotAdd") 
if msg.content.voice_chats then
for k,v in pairs(list) do 
...
LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 تمت الاذاعه الى 𓄼"..#list.."𓄹 جروب في البوت* ","md",true)      
Redis:del(Timo.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false
end
------------------------------------------------------------------------------------------------------------
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n*𓄼๏𓄹 تم الغاء الاذاعه بالتوجيه للمجموعات*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(Timo.."Timo:ChekBotAdd")   
LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹  تم التوجيه الى 𓄼"..#list.."𓄹 جروب في البوت*","md",true)      
for k,v in pairs(list) do  
LuaTele.forwardMessages(v, msg_chat_id, msg_id,0,0,true,false,false)
end   
Redis:del(Timo.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n 𓄼๏𓄹 تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Timo.."Timo:Change:Timo:Name:Bot"..msg.sender.user_id) 
Redis:set(Timo.."Timo:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " 𓄼๏𓄹 تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Timo.."Timo:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(Timo.."Timo:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n 𓄼๏𓄹 تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Timo.."Timo:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Timo.."Timo:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " 𓄼๏𓄹 تم تغيير كليشه start - "..text,"md",true)    
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
else
Redis:del(Timo.."Timo:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
...
Redis:incrby(Timo.."Timo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
else
Redis:del(Timo.."Timo:Game:Monotonous"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - حزوره","md",true)  
else
Redis:del(Timo.."Timo:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - حزوره","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - معاني","md",true)  
else
Redis:del(Timo.."Timo:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - معاني","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - العكس","md",true)  
else
Redis:del(Timo.."Timo:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - العكس","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
...
Redis:del(Timo.."Timo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Timo.."Timo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اوبس لقد خسرت في اللعبه \n 𓄼๏𓄹 حظآ اوفر في المره القادمه \n 𓄼๏𓄹 كان الرقم الذي تم تخمينه { "..GETNUM.." }","md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اوبس تخمينك غلط \n 𓄼๏𓄹 ارسل رقم تخمنه مره اخرى ","md",true)  
end
end
end
end
...
Redis:incrby(Timo.."Timo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - المختلف","md",true)  
else
Redis:del(Timo.."Timo:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - المختلف","md",true)  
end
...
Redis:incrby(Timo.."Timo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد فزت في اللعبه \n 𓄼๏𓄹 اللعب مره اخره وارسل - امثله","md",true)  
else
Redis:del(Timo.."Timo:Game:Example"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 لقد خسرت حضا اوفر في المره القادمه\n 𓄼๏𓄹 اللعب مره اخره وارسل - امثله","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(1)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
...
LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 جاري استرجاع المشتركين والجروبات ...')
Y = 0
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 تم استرجاع {'..X..'} مجموعه \n 𓄼๏𓄹 واسترجاع {'..Y..'} مشترك في البوت')
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 تم استرجاع المجموعات من نسخه تشاكي')
else
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 الملف لا يدعم هاذا البوت')
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تعطيل الاذاعه ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تفعيل الاذاعه للمطورين ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تعطيل المغادره ","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Timo.."Timo:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(Timo.."Timo:AddSudosNew"..msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id, "\n 𓄼๏𓄹 تم الغاء امر تغيير المطور الاساسي","md",true)    
end 
Redis:del(Timo.."Timo:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
end
if UserId_Info.type.is_channel == true then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  
end
if UserName and UserName[2]:match('(%S+)[Bb][Oo][Tt]') then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا تستطيع استخدام معرف البوت ","md",true)  
end
local Informationlua = io.open("Information.lua", 'w')
Informationlua:write([[
return {
...
Informationlua:close()
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 تم تغيير المطور الاساسي اصبح على : [@"..text:gsub('@','').."]","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل معرف المطور الاساسي مع @","md",true)
end
...
File:write(Get_Json)
File:close()
return LuaTele.sendDocument(msg_chat_id,msg_id,'./'..UserBot..'.json', '* 𓄼๏𓄹 تم جلب النسخه\n 𓄼๏𓄹 احصائيات𓄼 '..#Groups..' 𓄹المجموعات \n 𓄼๏𓄹 احصائيات𓄼 '..#UsersBot..' 𓄹المشتركين *\n', 'md')
end
...
LuaTele.sendText(msg_chat_id,msg_id,'* 𓄼๏𓄹 تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *',"md",true)  
elseif text == 'الاحصائيات' or text == '𓄼 الاحصائيات 𓄹' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(2)..' 𓄹* ',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(Timo..'Timo:Num:Add:Bot'),"md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 اسم الجروب -›𓄼*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*𓄹\n 𓄼๏𓄹 تم التفعيل من قبل *',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
LuaTele.sendText(Sudo_Id,0,'*\n 𓄼๏𓄹 تم تفعيل مجموعه جديده \n 𓄼๏𓄹 المستخدم -›𓄼*['..UserInfo.first_name..'](tg://user?id='..msg.sender.user_id..')*𓄹\n 𓄼๏𓄹 معلومات الجروب -› \n 𓄼๏𓄹 عدد الاعضاء -› '..Info_Chats.member_count..'\n 𓄼๏𓄹 عدد الادمنيه -› '..Info_Chats.administrator_count..'\n 𓄼๏𓄹 عدد المطرودين -› '..Info_Chats.banned_count..'\n 𓄼๏𓄹 عدد المقيدين -› '..Info_Chats.restricted_count..'*',"md",true, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 اسم الجروب -›𓄼*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*𓄹\n 𓄼๏𓄹 تم تفعيل الجروب *','md', true, false, false, false, reply_markup)
end
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا انته لست ادمن او مالك الجروب *","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(Timo.."Timo:ChekBotAdd",msg_chat_id) then
...
if photo.total_count > 0 then
local ban_ns ='\n* '..Description..'\n𓄼๏𓄹ᴜѕᴇ = '..banusername..'\n𓄼๏𓄹ѕᴛᴀ =  '..RinkBot..'\n𓄼๏𓄹 ɪᴅ = '..UserId..'\n𓄼๏𓄹ᴍѕɢ =  '..TotalMsg..'\n𓄼๏𓄹 ᴛᴘᴅʏʟᴀᴛᴋ =  '..TotalEdit..'\n𓄼๏𓄹ᴛғᴀᴘʟᴋ =  '..TotalMsgT..'\n𓄼๏𓄹ʙɪᴏ = '..getbio(UserId)..'*'
data = {} 
...
local ban_ns ='\n𓄼๏𓄹 ѕᴛᴀ =  '..RinkBot..'\n𓄼๏𓄹 ɪᴅ = '..UserId..'\n𓄼๏𓄹 ᴍѕɢ =  '..TotalMsg..'\n𓄼๏𓄹 ᴛᴘᴅʏʟᴀᴛᴋ =  '..TotalEdit..'\n𓄼๏𓄹 ᴛғᴀᴘʟᴋ =  '..TotalMsgT..'\n𓄼๏𓄹 ʙɪᴏ = '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
{
{text =news,url = "https://t.me/"..ban.username..""}, 
...
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*𓄼๏𓄹 عذرآ البوت ليس ادمن في الجروب يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
PermissionsUser = '*\n𓄼๏𓄹 صلاحيات المستخدم :\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n𓄼๏𓄹 تغيير المعلومات : '..change_info..'\n𓄼๏𓄹 تثبيت الرسائل : '..pin_messages..'\n𓄼๏𓄹 اضافه مستخدمين : '..invite_users..'\n𓄼๏𓄹 مسح الرسائل : '..delete_messages..'\n𓄼๏𓄹 حظر المستخدمين : '..restrict_members..'\n𓄼๏𓄹 اضافه المشرفين : '..promote..'\n\n*'
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هذا الامر يخص { '..Controller_Num(5)..' }* ',"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 عدد الميديا الموجود هو (* "..gmria.." *)","md")
end
if text == "تعطيل المسح التلقائي" then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص { '..Controller_Num(3)..' }* ',"md",true)  
end
Redis:del(Timo.."Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,'𓄼๏𓄹 تم تعطيل المسح التلقائي للميديا')
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,'𓄼๏𓄹 تم تفعيل المسح التلقائي للميديا')
return false
end 

if text == 'كشف البوت' then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 البوت عضو في الجروب ',"md",true) 
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 البوت ليس لديه صلاحيه حذف الرسائل* ',"md",true)  
end
if tonumber(NumMessage) > 1000 then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 العدد اكثر من 1000 لا تستطيع الحذف',"md",true)  
end
...
LuaTele.sendText(msg_chat_id, msg_id, " 𓄼๏𓄹 تم تنظيف - "..NumMessage.. ' رساله', 'md')
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* 𓄼๏𓄹 تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* 𓄼๏𓄹 تم تنزيله مطور ثانوي *").Reply,"md",true)  
end
end
if UserName[1]  == 'مساعد' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𓄼๏𓄹 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
Redis:del(Timo.."HELPBEVQ:Groups", bana.id)
Redis:del(Timo.."id:HELPBEVQ:Groups", bana.id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𓄼๏𓄹 تم تنزيله مساعد").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله مطور ").Reply,"md",true)  
end
end
if UserName[1] == "مالك" then
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(3)..' 𓄹* ',"md",true)  
end
if not Redis:sismember(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله مالك ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.TheBasicsm then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص { '..Controller_Num(44)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله منشئ اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(4)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Originators:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المنشئين ").Reply,"md",true)  
end
end
if UserName[1] == "مدير" then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(5)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Managers:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المدراء ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من الادمنيه ").Reply,"md",true)  
end
end
if UserName[1] == "مميز" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(7)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
if ban and ban.type and ban.type.luatele == "userTypeBot" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا تستطيع استخدام الامر على البوت ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مطور ثانوي").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𓄼๏𓄹 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𓄼๏𓄹 تم تنزيله مساعد").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مطور ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله مالك ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله منشئ اساسي ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المنشئين ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المدراء ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من الادمنيه ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا تستطيع استخدام ايدي خطأ ","md",true)  
end
if ban.message == "Invalid user ID" then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* 𓄼๏𓄹 تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* 𓄼๏𓄹 تم تنزيله مطور ثانوي *").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𓄼๏𓄹 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
Redis:del(Timo.."HELPBEVQ:Groups", UserId)
Redis:del(Timo.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𓄼๏𓄹 تم تنزيله مساعد").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم تنزيله مطور ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله مالك ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:TheBasics:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله منشئ اساسي ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Originators:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المنشئين ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Managers:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المدراء ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Addictive:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من الادمنيه ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:Distinguished:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم تنزيله من المميزبن ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مطور ثانوي").Reply,"md",true)  
end
end
if UserName[1] == "مساعد" then
if not msg.ControllerBot then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𓄼๏𓄹 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
Redis:sadd(Timo.."HELPBEVQ:Groups", UserId)
Redis:set(Timo.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𓄼๏𓄹 تم ترقيته مساعد").Reply,"md",true)  
end
end
if UserName[1] == "مطور" then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مطور ").Reply,"md",true)  
end
end
if UserName[1] == "مالك" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مالك ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.TheBasicsm then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته منشئ اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ" then
if not msg.TheBasics then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Originators:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته منشئ  ").Reply,"md",true)  
end
end
if UserName[1] == "مدير" then
if not msg.Originators then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Managers:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مدير  ").Reply,"md",true)  
end
end
if UserName[1] == "ادمن" then
if not msg.Managers then
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Timo.."Timo:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته ادمن  ").Reply,"md",true)  
end
end
if UserName[1] == "مميز" then
if not msg.Addictive then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم ترقيته مميز  ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مطور ثانوي").Reply,"md",true)  
end
end
if TextMsg == 'مساعد' then
if not msg.ControllerBot then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𓄼๏𓄹 تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"𓄼๏𓄹 تم ترقيته  مساعد").Reply,"md",true)  
end
end
if TextMsg == 'مطور' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مطور ").Reply,"md",true)  
end
end
if TextMsg == "مالك" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مالك ").Reply,"md",true)  
end
end
if TextMsg == "منشئ اساسي" then
if not msg.TheBasicsm then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته منشئ اساسي ").Reply,"md",true)  
end
end
if TextMsg == "منشئ" then
if not msg.TheBasics then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته منشئ  ").Reply,"md",true)  
end
end
if TextMsg == "مدير" then
if not msg.Originators then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مدير  ").Reply,"md",true)  
end
end
if TextMsg == "ادمن" then
if not msg.Managers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته ادمن  ").Reply,"md",true)  
end
end
if TextMsg == "مميز" then
if not msg.Addictive then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم ترقيته مميز  ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم ترقيته مطور ثانوي").Reply,"md",true)  
end
end
if UserId[1] == 'مساعد' then
if not msg.ControllerBot then 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𓄼๏𓄹 تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(Timo.."HELPBEVQ:Groups")
Redis:sadd(Timo.."HELPBEVQ:Groups", UserId)
Redis:set(Timo.."id:HELPBEVQ:Groups", UserId)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𓄼๏𓄹 تم مساعد").Reply,"md",true)  
end
end
if UserId[1] == 'مطور' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم ترقيته مطور ").Reply,"md",true)  
end
end
if UserId[1] == "مالك" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مالك ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ اساسي" then
if not msg.TheBasicsm then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:TheBasics:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته منشئ اساسي ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ" then
if not msg.TheBasics then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Originators:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته منشئ  ").Reply,"md",true)  
end
end
if UserId[1] == "مدير" then
if not msg.Originators then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Managers:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مدير  ").Reply,"md",true)  
end
end
if UserId[1] == "ادمن" then
if not msg.Managers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Addictive:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته ادمن  ").Reply,"md",true)  
end
end
if UserId[1] == "مميز" then
if not msg.Addictive then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:Distinguished:Group"..msg_chat_id,UserId[2]) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," 𓄼๏𓄹 تم ترقيته مميز  ").Reply,"md",true)  
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المطور الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المنشئ الاساسي الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المنشئ الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المالك الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المدير الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد الادمن الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغير رد المميز الى :"..Teext)
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم حذف رد العضو")
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 لا يوجد مطورين ثانوين في البوت*","md",true)  
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح الثانوين 𓄼๏𓄹', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 لا يوجد مطورين في البوت*","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه مطورين البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المطورين 𓄼๏𓄹', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد مالكين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المالكين في البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المالكين 𓄼๏𓄹', data = msg.sender.user_id..'/TheBasicsQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد منشئين اساسيين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المنشئين الاساسيين ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المنشئين الاساسيين 𓄼๏𓄹', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد منشئين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المنشئين في البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المنشئين 𓄼๏𓄹', data = msg.sender.user_id..'/Originators'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد مدراء في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المدراء في البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المدراء 𓄼๏𓄹', data = msg.sender.user_id..'/Managers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد ادمنيه في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه الادمنيه في البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح الادمنيه 𓄼๏𓄹', data = msg.sender.user_id..'/Addictive'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد مميزين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المميزين في البوت ⇧⇩*\n⩹┉┉┉┉⊶❲𖥳 𝐒𝐀??𝐃𝐈 𖥳❳⊷┉┉┉┉⩺\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المميزين 𓄼๏𓄹', data = msg.sender.user_id..'/DelDistinguished'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد محظورين عام في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المحظورين عام ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المحظورين عام 𓄼๏𓄹', data = msg.sender.user_id..'/BanAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 لا يوجد مكتومين عام في البوت ","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المكتومين عام ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المكتومين عام 𓄼๏𓄹', data = msg.sender.user_id..'/ktmAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد محظورين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المحظورين في البوت ⇧⇩*\n⩹┉┉┉┉⊶❲𖥳 𝐒𝐀?????? 𖥳❳⊷┉┉┉┉⩺\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المحظورين 𓄼๏𓄹', data = msg.sender.user_id..'/BanGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد مكتومين في البوت *","md",true)  
end
ListMembers = '\n* 𓄼๏𓄹 قائمه المكتومين في البوت ⇧⇩*\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
for k, v in pairs(Info_Members) do
local ban = LuaTele.getUser(v)
if ban and ban.username and ban.username ~= "" then
ListMembers = ListMembers.."*"..k.." - *[@"..ban.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '𓄼๏𓄹 مسح المكتومين 𓄼๏𓄹', data = msg.sender.user_id..'/SilentGroupGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Timo.."Timo:Status:Welcome"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الترحيب *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الايدي *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الايدي بالصوره *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الردود *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الردود العامه *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الحظر , الطرد , التقييد*","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الرفع *","md",true)
end
if TextMsg == 'الالعاب' then
Redis:set(Timo.."Timo:Status:Games"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل الالعاب *","md",true)
end
if TextMsg == 'التحقق' then
Redis:set(Timo.."Timo:Status:joinet"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل التحقق *","md",true)
end
if TextMsg == 'اطردني' then
Redis:set(Timo.."Timo:Status:KickMe"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل اطردني *","md",true)
end
if TextMsg == 'صورتي' then
Redis:set(Timo.."Status:photo"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تفعيل صورتي ","md",true)
end
if TextMsg == 'قول' then
Redis:set(Timo.."Status:kool"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تفعيل امر قول ","md",true)
end
if TextMsg == 'جمالي' then
Redis:set(Timo.."Status:gamle"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تفعيل جمالي ","md",true)
end
if TextMsg == 'ردود السورس' then
Redis:set(Timo.."Timo:Sasa:Jeka"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(Timo.."Timo:Status:remMe"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل نزلني *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل البوت الخدمي *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تفعيل التواصل داخل البوت *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Timo.."Timo:Status:Welcome"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الترحيب *","md",true)
end
if TextMsg == 'الايدي' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الايدي *","md",true)
end
if TextMsg == 'الايدي بالصوره' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الايدي بالصوره *","md",true)
end
if TextMsg == 'الردود المضافه' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الردود *","md",true)
end
if TextMsg == 'الردود العامه' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الردود العامه *","md",true)
end
if TextMsg == 'الحظر' or TextMsg == 'الطرد' or TextMsg == 'التقييد' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(6)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الحظر , الطرد , التقييد*","md",true)
end
if TextMsg == 'الرفع' then
if not msg.Originators then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(5)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الرفع *","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Timo.."Timo:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل الالعاب *","md",true)
end
if TextMsg == 'التحقق' then
Redis:del(Timo.."Timo:Status:joinet"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل التحقق *","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Timo.."Timo:Status:KickMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل اطردني *","md",true)
end
if TextMsg == 'صورتي' then
Redis:del(Timo.."Status:photo"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تعطيل صورتي ","md",true)
end
if TextMsg == 'قول' then
Redis:del(Timo.."Status:kool"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تعطيل امر قول ","md",true)
end
if TextMsg == 'جمالي' then
Redis:del(Timo.."Status:gamle"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 تم تعطيل جمالي ","md",true)
end
if TextMsg == 'ردود السورس' then
Redis:del(Timo.."Timo:Sasa:Jeka"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:del(Timo.."Timo:Status:remMe"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل نزلني *","md",true)
end
if TextMsg == 'البوت الخدمي' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(1)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل البوت الخدمي *","md",true)
end
if TextMsg == 'التواصل' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(1)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم تعطيل التواصل داخل البوت *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:BanAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* 𓄼๏𓄹 تم حظره عام من المجموعات *").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,UserId_Info.id) == 'المطور الاساسي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المطور الثانوي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:ktmAll:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:ktmAll:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  
end
if not msg.Originators and not Redis:get(Timo.."Timo:Status:BanId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تعطيل 𓄼الحظر : الطرد : التقييد𓄹 من قبل المدراء","md",true)
end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا لا يوجد حساب بهاذا المعرف ","md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع حظر𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم?? "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
if StatusCanOrNotCan(msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع تقييد𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تقييده في الجروب \n 𓄼๏𓄹 لمدة : "..UserName[1]..' '..UserName[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع تقييد𓄼"..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تقييده في الجروب \n 𓄼๏𓄹 لمدة : "..TimeKed[1]..' '..TimeKed[2]).Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع تقييد 𓄼 "..Controller(msg_chat_id,UserId[3]).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تقييده في الجروب ").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
if text == ('كتم عام') and msg.reply_to_message_id ~= 0 then
if not msg.DevelopersQ then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص ?? '..Controller_Num(2)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المطور الاساسي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المطور الثانوي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:ktmAll:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:ktmAll:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع حظر𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تقييده في الجروب ").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء تقييده من الجروب").Reply,"md",true)  
end
...
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع طرد𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم طرد من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"* 𓄼๏𓄹 تم طرده من الجروب *").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء طردن من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم الغاء طرده من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:BanAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم حظره عام من المجموعات ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:BanAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء حظره عام من المجموعات  ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,UserId) == 'المطور الاساسي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم  عام𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المطور الثانوي' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عذرا لا تستطيع كتم  عام𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:ktmAll:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم كتمه عام من المجموعات ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:ktmAll:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء كتمه عام من المجموعات  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  𓄼๏𓄹 عذرا لا تستطيع حظر𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم حظره من الجروب ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(Timo.."Timo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء حظره من الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  𓄼๏𓄹 عذرا لا تستطيع كتم𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
if Redis:sismember(Timo.."Timo:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(Timo.."Timo:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم كتمه في الجروب  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
...
if StatusCanOrNotCan(msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*  𓄼๏𓄹 عذرا لا تستطيع تقييد𓄼 "..Controller(msg_chat_id,UserId).." 𓄹*","md",true)  
end
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,0,0,0,0,0,0,0,0})
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم تقييده في الجروب ").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," 𓄼๏𓄹 تم الغاء تقييده من الجروب").Reply,"md",true)  
end

if text == "نزلني" then
if not Redis:get(Timo.."Timo:Status:remMe"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 امر نزلني تم تعطيله من قبل المدراء *","md",true)  
end
...
if Rink == 10 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 ليس لديك رتب عزيزي *","md",true)  
end
if Rink <= 7  then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 استطيع تنزيل الادمنيه والمميزين فقط","md",true) 
else
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end
...
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
local ban_ns = '𓄼๏𓄹 ʜᴇʀᴇ ᴀʀᴇ ʏᴏ𝗎ʀ ᴘʜᴏᴛᴏѕ'
if photo.total_count > 0 then
data = {} 
data.inline_keyboard = {
{
...
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹هذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
local Info_Members = LuaTele.searchChatMembers(msg_chat_id, "*", 200)
x = 0
tags = 0
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 لايوجد زوجات*',"md",true) 
end 
local zwga_list = "* 𓄼๏𓄹 قائمة الزوجات *"..#zwgat_list.."\n*༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻*\n"
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 لايوجد متوحدين *',"md",true) 
end 
local lone_list = "* 𓄼๏𓄹 قائمة متوحدين الجروب *"..#lonely_list.."\n*༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻*\n"
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 لايوجد مطلقات*',"md",true) 
end 
local mutlqa_list = "* 𓄼๏𓄹 قائمة المطلقات *"..#mutlqat_list.."\n*༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻*\n"
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 لايوجد الكلاب *',"md",true) 
end 
local klbk_list = "* 𓄼๏𓄹 قائمة الكلاب الجروب *"..#klbklb_list.."\n*༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻*\n"
...
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص「 '..Controller_Num(7)..' 」* ',"md",true)  
end
Redis:set(Timo.."addchannel"..msg.sender.user_id,"on") 
LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹  ارسل ايدي القناه","md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𓄼๏𓄹 تم قفـل القنوات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الدردشه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل اضافة الاعضاء").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل دخول الاعضاء").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل البوتات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل البوتات").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الاشعارات").Lock,"md",true)  
return false
end 
if text == "تعطيل all" or text == "تعطيل @all" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص「 '..Controller_Num(6)..' 」* ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Timo.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𓄼๏𓄹 تم قفـل @all هنا").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𓄼๏𓄹 تم فتح @all هنا").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التثبيت هنا").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل تعديل").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل جميع الاوامر").Lock,"md",true)  
return false
end
if text == "تفعيل الحمايه" then 
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص ?? '..Controller_Num(7)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تـم تفعيل الحمايه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح اضافة الاعضاء").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𓄼๏𓄹 تم فتح القنوات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹  تم وضع عدد تكرار '..Num..'* ',"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الدردشه").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح دخول الاعضاء").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فـتح البوتات").unLock,"md",true)  
return false
end 
if text == "فتح البوتات " then 
if not msg.Developers then
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فـتح الاشعارات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فـتح التثبيت هنا").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فـتح تعديل").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فـتح جميع الاوامر").unLock,"md",true)  
return false
end 
--------------------------------------------------------------------------------------------------------------
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التكرار").Lock,"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التكرار").lockKid,"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التكرار").lockKtm,"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التكرار").lockKick,"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح التكرار").unLock,"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الروابط").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الروابط").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الروابط").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الروابط").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الروابط").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المعرفات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المعرفات").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المعرفات").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المعرفات").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح المعرفات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التاك").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التاك").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التاك").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التاك").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح التاك").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الشارحه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الشارحه").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الشارحه").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الشارحه").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الشارحه").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصور").Lock,"md",true)  
return false
end 
if text == "قفل الصور بالتقيد" then 
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(7)..' ??* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصور").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصور").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الصور").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الفيديو").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الفيديو").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الفيديو").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الفيديو").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الفيديو").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المتحركه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المتحركه").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المتحركه").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل المتحركه").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح المتحركه").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الالعاب").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الالعاب").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الالعاب").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الالعاب").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الالعاب").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الاغاني").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الاغاني").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الاغاني").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الاغاني").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الاغاني").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصوت").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصوت").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصوت").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الصوت").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الصوت").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكيبورد").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكيبورد").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكيبورد").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكيبورد").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الكيبورد").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملصقات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملصقات").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملصقات").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملصقات").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الملصقات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التوجيه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التوجيه").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التوجيه").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل التوجيه").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح التوجيه").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملفات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملفات").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملفات").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الملفات").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الملفات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل السيلفي").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل السيلفي").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل السيلفي").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل السيلفي").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح السيلفي").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الماركداون").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الماركداون").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الماركداون").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الماركداون").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الماركداون").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الجهات").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الجهات").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الجهات").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الجهات").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الجهات").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكلايش").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكلايش").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكلايش").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الكلايش").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الكلايش").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الانلاين").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الانلاين").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الانلاين").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم قفـل الانلاين").lockKick,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," 𓄼๏𓄹 تم فتح الانلاين").unLock,"md",true)  
return false
end 
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل رابط الجروب او رابط قناة الجروب","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم مسح الرابط ","md",true)             
end
if text == "الرابط" or text == "رابط" or text == "الينك" then
if not Redis:get(Timo.."Timo:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 تم تعطيل جلب الرابط من قبل الادمنيه*","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
...
local LinkGroup = LuaTele.generateChatInviteLink(msg_chat_id,'Hussain',tonumber(msg.date+86400),0,true)
if LinkGroup.code == 3 then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 لا استطيع جلب اسم الجروب بسبب ليس لدي صلاحيه دعوه مستخدمين من خلال اسم الجروب ","md",true)
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text = Get_Chat.title, url = LinkGroup.invite_link},},}}
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل لي الترحيب الان".."\n 𓄼๏𓄹 تستطيع اضافة مايلي !\n 𓄼๏𓄹 دالة عرض الاسم »{`name`}\n 𓄼๏𓄹 دالة عرض المعرف »{`user`}\n 𓄼๏𓄹 دالة عرض اسم الجروب »{`NameCh`}","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تعطيل الترحيب من قبل الادمنيه","md",true)
end 
local Welcome = Redis:get(Timo.."Timo:Welcome:Group"..msg_chat_id)
if Welcome then 
return LuaTele.sendText(msg_chat_id,msg_id,Welcome,"md",true)   
else 
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 لم يتم تعيين ترحيب للمجموعه","md",true)   
end 
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم ازالة ترحيب الجروب","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل لي القوانين الان","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم ازالة قوانين الجروب","md",true)    
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 لا توجد قوانين هنا","md",true)     
end    
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 البوت ليس لديه صلاحيه تغيير المعلومات* ',"md",true)  
end
Redis:setex(Timo.."Timo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل لي وصف الجروب الان","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم تغيير اسم الجروب الى : "..NameChat,"md",true)    
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل الصوره لوضعها","md",true)    
end
...
if #list == 0 then  
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 لا يوجد كلمات ممنوعه هنا *","md",true)   
end  
for k,v in pairs(list) do  
v = v:gsub('photo:',"") 
v = v:gsub('sticker:',"") 
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح ("..#list..") كلمات ممنوعه *","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end    
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 الان ارسل لي الامر القديم ...","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم مسح جميع الاوامر التي تم اضافتها في العام","md",true)
end
...
local list = Redis:smembers(Timo.."Timo:All:Command:List:Group")
Command = " 𓄼๏𓄹 قائمه الاوامر المضافه العامه  \n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = " 𓄼๏𓄹 لا توجد اوامر اضافيه عامه"
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم مسح جميع الاوامر التي تم اضافتها","md",true)
end
...
local list = Redis:smembers(Timo.."Timo:Command:List:Group"..msg_chat_id.."")
Command = " 𓄼๏𓄹 قائمه الاوامر المضافه  \n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = " 𓄼๏𓄹 لا توجد اوامر اضافيه"
end
return LuaTele.sendText(msg_chat_id,msg_id,Command,"md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 البوت ليس لديه صلاحيه تثبيت الرسائل* ',"md",true)  
end
LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 تم تثبيت الرساله","md",true)
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 تم الغاء تثبيت الرساله","md",true)
...
LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 تم الغاء تثبيت كل الرسائل","md",true)
...
{
{text = '𓄼๏𓄹 اخفاء الامر 𓄼๏𓄹', data =msg.sender.user_id..'/'.. 'delAmr'}
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, ' 𓄼๏𓄹 اوامر التفعيل والتعطيل ', 'md', false, false, false, false, reply_markup)
end  
...
local protectionGroup = '\n* 𓄼๏𓄹 اعدادات حمايه الجروب\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n'
..'\n 𓄼๏𓄹 جلب الرابط⇦ '..Statuslink
..'\n 𓄼๏𓄹 جلب الترحيب⇦ '..StatusWelcome
..'\n 𓄼๏𓄹 الايدي⇦ '..StatusId
..'\n 𓄼๏𓄹 الايدي بالصوره⇦ '..StatusIdPhoto
..'\n 𓄼๏𓄹 الردود المضافه⇦ '..StatusReply
..'\n 𓄼๏𓄹 الردود العامه⇦ '..StatusReplySudo
..'\n 𓄼๏𓄹 الرفع⇦ '..StatusSetId
..'\n 𓄼๏𓄹 الحظر - الطرد⇦ '..StatusBanId
..'\n 𓄼๏𓄹 الالعاب⇦ '..StatusGames
..'\n 𓄼๏𓄹 امر اطردني⇦ '..Statuskickme..'*\n\n'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𓄼๏𓄹 القائمه الثانيه 𓄼๏𓄹', data =msg.sender.user_id..'/'.. 'NextSeting'}
},
{
{text = '𓄼๏𓄹 اخفاء الامر 𓄼๏𓄹', data =msg.sender.user_id..'/'.. 'delAmr'}
},
...
local permissions = '*\n 𓄼๏𓄹 صلاحيات الجروب :\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻'..'\n 𓄼๏𓄹 ارسال الويب : '..web..'\n 𓄼๏𓄹 تغيير معلومات الجروب : '..info..'\n 𓄼๏𓄹 اضافه مستخدمين : '..invite..'\n 𓄼๏𓄹 تثبيت الرسائل : '..pin..'\n 𓄼๏𓄹 ارسال الميديا : '..media..'\n 𓄼๏𓄹 ارسال الرسائل : '..messges..'\n 𓄼๏𓄹 اضافه البوتات : '..other..'\n 𓄼๏𓄹 ارسال استفتاء : '..polls..'*\n\n'
local TextChat = '*\n 𓄼๏𓄹 معلومات الجروب :\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻'..' \n 𓄼๏𓄹 عدد الادمنيه : ❬ '..Info_Chats.administrator_count..' ❭\n 𓄼๏𓄹 عدد المحظورين : ❬ '..Info_Chats.banned_count..' ❭\n 𓄼๏𓄹 عدد الاعضاء : ❬ '..Info_Chats.member_count..' ❭\n 𓄼๏𓄹 عدد المقيديين : ❬ '..Info_Chats.restricted_count..' ❭\n 𓄼๏𓄹 اسم الجروب : ❬* ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* ❭*'
...
return LuaTele.sendText(msg_chat_id, msg_id, " 𓄼๏𓄹 الصلاحيات - ", 'md', false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 ليس لديه اي رتبه هنا *","md",true)  
end
if msg.ControllerBot then
if Rink == 1 or Rink < 1 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  
end
Redis:srem(Timo.."Timo:Developers:Groups",Message_Reply.sender.user_id)
Redis:srem(Timo.."Timo:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(Timo.."Timo:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 تم تنزيل الشخص من الرتب التاليه { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." *}","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 البوت ليس لديه صلاحيه اضافة مشرفين* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
local ban = LuaTele.getUser(Message_Reply.sender.user_id)
if ban.message == "Invalid user ID" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم وضع له لقب : "..CustomTitle).Reply,"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end
...
local SetCustomTitle_ = JSON.decode(SetCustomTitle)
if SetCustomTitle_.result == true then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم وضع له لقب : "..UserName[2]).Reply,"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 عذرا هناك خطا تاكد من البوت ومن الشخص","md",true)  
end 
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 لا يمكنني رفعه ليس لدي صلاحيات *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '𓄼๏𓄹 تعديل الصلاحيات 𓄼๏𓄹', data = msg.sender.user_id..'/groupNumseteng//'..Message_Reply.sender.user_id}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, " 𓄼๏𓄹 صلاحيات المستخدم - ", 'md', false, false, false, false, reply_markup)
end
...
data = {
{
{text = '𓄼๏𓄹 تعديل الصلاحيات 𓄼๏𓄹', data = msg.sender.user_id..'/groupNumseteng//'..UserId_Info.id}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id, " 𓄼๏𓄹 صلاحيات المستخدم - ", 'md', false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 لست انا من قام برفعه *","md",true)  
end
if SetAdmin.code == 3 then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 لا يمكنني تنزيله ليس لدي صلاحيات *","md",true)  
end
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم تنزيله من المشرفين ").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," 𓄼๏𓄹 تم تنزيله من المشرفين ").Reply,"md",true)  
end 
if text == 'مسح رسائلي' then
Redis:del(Timo..'Timo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Timo..'Timo:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Timo..'Timo:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 عدد رسائلك هنا ⇦ '..(Redis:get(Timo..'Timo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 عدد التعديلات هنا ⇦ '..(Redis:get(Timo..'Timo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 عدد جهاتك يبشا ⇦ '..(Redis:get(Timo.."Timo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,[[
 𓄼๏𓄹 ارسل الان النص
 𓄼๏𓄹 يمكنك اضافه :
 𓄼๏𓄹 `#username` » اسم المستخدم
 𓄼๏𓄹 `#msgs` » عدد الرسائل
 𓄼๏𓄹 `#photos` » عدد الصور
 𓄼๏𓄹 `#id` » ايدي المستخدم
 𓄼๏𓄹 `#auto` » نسبة التفاعل
 𓄼๏𓄹 `#stast` » رتبة المستخدم 
 𓄼๏𓄹 `#edit` » عدد السحكات
 𓄼๏𓄹 `#game` » عدد المجوهرات
 𓄼๏𓄹 `#AddMem` » عدد الجهات
 𓄼๏𓄹 `#Description` » تعليق الصوره
]],"md",true)    
end 
...
return LuaTele.sendText(msg_chat_id,msg_id, ' 𓄼๏𓄹 تم ازالة كليشة الايدي العامه',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id, ' 𓄼๏𓄹 تم ازالة كليشة الايدي ',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المطورين الثانويين*","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المطورين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المنشؤين الاساسيين *","md",true)
end
...
Redis:del(Timo.."Timo:TheBasics:Group"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المالكين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المنشئين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المدراء *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من الادمنيه *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المميزين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المحظورين عام *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المكتومين عام *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المحظورين *","md",true)
end
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 لا يوجد مطردين في الجروب ","md",true)  
end
Redis:del(Timo.."Timo:MosTafa:Ahmed"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المطرودين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..#Info_Members.."} من المكتومين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح {"..x.."} من المقيديين *","md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عدد البوتات الموجوده : "..#List_Members.."\n 𓄼๏𓄹 تم طرد ( "..x.." ) بوت من الجروب *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 عدد المطرودين في الموجوده : "..#List_Members.."\n 𓄼๏𓄹 تم الغاء طرد عن ( "..x.." ) من الاشخاص*","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 تم طرد ( "..x.." ) حساب محذوف *","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم مسح قائمه الردود *","md",true)  
end
...
if #list == 0 then
text = " 𓄼๏𓄹 لا يوجد ردود في الجروب"
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 ارسل الان الكلمه لاضافتها في ردود *","md",true)  
end
if text == "حذف رد" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(7)..' 𓄹* ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ارسل الان الكلمه لحذفها من ردود *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حذف قائمه الردود العامه *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ارسل الان الكلمه لاضافتها في الردود العامه *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹 ارسل الان الكلمه لحذفها من الردود العامه","md",true)  
end
if text=="اذاعه خاص" then 
if not msg.Developers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص𓄼 '..Controller_Num(2)..' 𓄹* ',"md",true)  
end
if not msg.ControllerBot and not Redis:set(Timo.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 الاذاعه معطله من قبل المطور الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Timo.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
...
LuaTele.sendText(msg_chat_id,msg_id,[[*
𓄼๏𓄹 ارسل اذاعتك لنشرها في أعضاء خاص البوت 
𓄼๏𓄹 للخروج من الامر ارسل𓄼الغاء𓄹
*]],"md",true)  
return false
end
...
LuaTele.sendText(msg_chat_id,msg_id,[[*
𓄼๏𓄹 ارسل اذاعتك لنشرها في الجروبات
𓄼๏𓄹 للخروج من الامر ارسل𓄼الغاء𓄹
*]],"md",true)  
return false
end
...
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹 هاذا الامر يخص𓄼 '..Controller_Num(1)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
LuaTele.sendText(msg_chat_id,msg_id,[[
𓄼๏𓄹 ارسل اذاعتك لتثبيت في الجروبات
𓄼๏𓄹 للخروج من الامر ارسل𓄼الغاء𓄹
]],"md",true)  
return false
end
...
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ارسل لي التوجيه الان*\n* 𓄼๏𓄹 ليتم نشره في المجموعات*\n* 𓄼๏𓄹 للخروج من الامر ارسل𓄼الغاء𓄹*","md",true)  
return false
end
...
LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ارسل لي التوجيه الان*\n* 𓄼๏𓄹 ليتم نشره الى اضاء خاص البوت*\n* 𓄼๏𓄹 للخروج من الامر ارسل𓄼الغاء𓄹*","md",true)  
return false
end
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 معلومات الكشف \n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻"..'\n 𓄼๏𓄹 الحظر العام : '..BanAll..'\n 𓄼๏𓄹 الحظر : '..BanGroup..'\n 𓄼๏𓄹 الكتم : '..SilentGroup..'\n 𓄼๏𓄹 التقييد : '..Restricted..'*',"md",true)  
end
...
LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 تم رفع القيود عنه : {"..BanAll..BanGroup..SilentGroup..Restricted..'}*',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 ارسل لي الكليشه الان')
end
...
return LuaTele.sendText(msg_chat_id,msg_id,' 𓄼๏𓄹 تم حذف كليشه المطور')
end
...
if #list == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹  لا يوجد وسائط مجدوله للحذف \n ","md",true) 
end
for k,v in pairs(list) do 
LuaTele.deleteMessages(msg.chat_id,{[1]= v})
end
Redis:del(Timo.."cleaner"..msg_chat_id)
LuaTele.sendText(msg_chat_id,msg_id,"𓄼๏𓄹  تم مسح "..#list.." من الميديا","md",true)
end
...
local  ban = LuaTele.getUser(v.member_id.user_id)
if  ban.first_name == "" then
LuaTele.sendText(msg_chat_id,msg_id,"*𓄼๏𓄹 اوبس , المالك حسابه محذوف *","md",true)  
return false
end 
...
if photo.total_count > 0 then
local TestText = "  ❲ 𝗼𝘄𝗻𝗲𝗿 𝗴𝗿𝗼𝘂𝗽 ❳\n— — — — — — — — —\n 𓄼๏𓄹*Owner Name* :  [".. ban.first_name.."](tg://user?id=".. ban.id..")\n𓄼๏𓄹 *Owner Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
...
if photo.total_count > 0 then
local TestText = "  ❲ Developers Bot ❳\n— — — — — — — — —\n 𓄼๏𓄹*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𓄼๏𓄹 *Dev Bio* : ["..Bio.." ]\n"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
local UserId_Info = LuaTele.searchPublicChat("tt_tt_4")
...
if photo.total_count > 0 then
local TestText = "𓄼•ᴅᴇᴠ•ᴛɪᴍᴏ•𓄹\n— — — — — — — — —\n 𓄼๏𓄹*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n𓄼๏𓄹 *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '𓄼•ᴅᴇᴠ•ᴛɪᴍᴏ•𓄹', url = "https://t.me/tt_tt_4"}
},
{
...
LuaTele.sendText(Sudo_Id,0,'*\n𓄼๏𓄹 مرحباً عزيزي المطور \nشخص ما يحتاج الي مساعده\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n𓄼๏𓄹 اسمه :- '..klajq..' \n𓄼๏𓄹 ايديه :-  : '..msg.sender.user_id..'\n𓄼๏𓄹 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج تيمو' or text == 'تيمو' or text == 'مبرمج السورس' or text == '𓄼 المبرمج تيمو 𓄹' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
LuaTele.sendText(5217455708,0,'*\n𓄼๏𓄹 مرحباً عزيزي المبرمج تيمو \nشخص ما يحتاج الي مساعده\n༺┉┉┉⊶﴾𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹﴿⊷┉┉┉༻\n𓄼๏𓄹 اسمه :- '..klajq..' \n𓄼๏𓄹 ايديه :-  : '..msg.sender.user_id..'\n𓄼๏𓄹 - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج سيزر' or text == 'سيزر' or text == 'مطور السورس' or text == '𓄼 المبرمج سيزر 𓄹' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
{
{text = '𓄼•ᴛɪᴍᴏ•𓄹', url = "https://t.me/tt_tt_4"},{text = '𓄼•ѕᴇᴢʀ•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•𓄹', url = "https://t.me/SU_SELVA"}
},
...
{
{text = '𓄼•™ʽ𝑻 𝑺ᯓ𝑺𝑬𝑳𝑽𝑨✘⃟🎌𓄼๏𓄹͈͈͈͈͈͈͈⌯•𓄹', url = "https://t.me/br_selva"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𓄼•الالــعــاب•𓄹 ', data = msg.sender.user_id..'/degm'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'𓄼๏𓄹  عليك استخدام اوامر التحكم بالقوائم',"md",false, false, false, false, reply_markup)
end
if text and text:match("^معني (.*)$") then
local TextName = text:match("^معني (.*)$")
...
local UserInfo = LuaTele.getUser(Message_Reply.sender.user_id)
if tonumber(Message_Reply.sender.user_id) == tonumber(Timo) then
return LuaTele.sendText(msg_chat_id,msg_id,"*لا استطيع استخدام الأمر علي البوت 𓄼๏𓄹*","md",true)  
end
...
zx = JSON.decode(zh)
t = "\n* 𓄼๏𓄹 قائمه الزخرفه ⇓⇑*\n*༺┉┉┉⊶﴾•ѕᴏ𝗎ʀᴄᴇ ѕᴇʟᴠᴀ•﴿⊷┉┉┉༻*\n* أضغط علي الاسم لا يتم النسخ 𓄼๏𓄹 *\n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  `"..v.."` \n"
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 ردود السورس معطلة*","md",true)  
end
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local reply_markup = LuaTele.replyMarkup{
...
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
 ...
 echo '𓄼๏𓄹   { نظام التشغيل } ⊰•\n*-› '"$linux_version"'*' 
 echo '*------------------------------\n*𓄼๏𓄹  { الذاكره العشوائيه } ⊰•\n*-› '"$memUsedPrc"'*'
 echo '*------------------------------\n*𓄼๏𓄹  { وحـده الـتـخـزيـن } ⊰•\n*-› '"$HardDisk"'*'
 echo '*------------------------------\n*𓄼๏𓄹  { الـمــعــالــج } ⊰•\n*-› '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
 echo '*------------------------------\n*𓄼๏𓄹  { موقـع الـسـيـرفـر } ⊰•\n*-› '`curl http://th3boss.com/ip/location`'*'
 echo '*------------------------------\n*𓄼๏𓄹  { الــدخــول } ⊰•\n*-› '`whoami`'*'
 echo '*------------------------------\n*𓄼๏𓄹  { مـده تـشغيـل الـسـيـرفـر } ⊰• \n*-› '"$uptime"'*'
 ]]):read('*all')
...
LuaTele.sendText(msg_chat_id,msg_id, "*𓄼๏𓄹 تم تحديث الملفات*","md",true)
dofile('Timo.lua')  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل لي الاسم الان ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏?? تم حذف اسم البوت ","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 امر المغادره معطل من قبل الاساسي *',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
return LuaTele.sendText(msg_chat_id,msg_id,'*𓄼๏𓄹 يرجاء تأكيد الأمر عزيزي*',"md",false, false, false, false, reply_markup)
end
...
if x ~= 0 then
return LuaTele.sendText(msg_chat_id,msg_id,'* 𓄼๏𓄹 العدد الكلي { '..#list..' }\n 𓄼๏𓄹 تم العثور على { '..x..' } من المشتركين حاظرين البوت*',"md")
else
return LuaTele.sendText(msg_chat_id,msg_id,'* 𓄼๏𓄹 العدد الكلي { '..#list..' }\n 𓄼๏𓄹 لم يتم العثور على وهميين*',"md")
end
end
...
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* 𓄼๏𓄹 البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
...
if x ~= 0 then
return LuaTele.sendText(msg_chat_id,msg_id,'* 𓄼๏𓄹 العدد الكلي { '..#list..' } للمجموعات \n 𓄼๏𓄹 تم العثور على { '..x..' } مجموعات البوت ليس ادمن \n 𓄼๏𓄹 تم تعطيل الجروب ومغادره البوت من الوهمي *',"md")
else
return LuaTele.sendText(msg_chat_id,msg_id,'* 𓄼๏𓄹 العدد الكلي { '..#list..' } للمجموعات \n 𓄼๏𓄹 لا توجد مجموعات وهميه*',"md")
end
end
if text == "سمايلات" or text == "سمايل" then
if Redis:get(Timo.."Timo:Status:Games"..msg.chat_id) then
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","??","🌭","🍔","🍠","🍕","🥪","🥙","☕️","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","⚔","🛡","🔮","??","💣","𓄼๏𓄹","📍","📓","📗","📂","📅","📪","📫","𓄼๏𓄹","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
Redis:set(Timo.."Timo:Game:Smile"..msg.chat_id,SM)
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}","md",true)  
end
end
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة. 𓄼๏𓄹 💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𓄼๏𓄹 ",
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يرتبها ~ {"..name.."}","md",true)  
end
end
if text == "حزوره" then
if Redis:get(Timo.."Timo:Status:Games"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يحل الحزوره ↓\n {"..name.."}","md",true)  
end
end
if text == "معاني" then
if Redis:get(Timo.."Timo:Status:Games"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يدز معنى السمايل ~ {"..name.."}","md",true)  
end
end
if text == "العكس" then
if Redis:get(Timo.."Timo:Status:Games"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يدز العكس ~ {"..name.."}","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id, [[*
╗•لعبه المحيبس هي لعبة الحظ 𓄼๏𓄹
╣•جرب حظك ويه البوت واتونس 𓄼๏𓄹
╣•كل ما عليك هوا الضغط على 𓄼๏𓄹
╝•احدى العضمات في الازرار 𓄼๏𓄹
*]],"md",false, false, false, false, reply_markup)
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n".." 𓄼๏𓄹 ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".." 𓄼๏𓄹 سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ","md",true)  
end
end
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"??","📆📆📆📆📆📆📅📆📆")
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يدز الاختلاف ~ {"..name.."}","md",true)  
end
end
if text == "امثله" then
if Redis:get(Timo.."Timo:Status:Games"..msg.chat_id) then
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 اسرع واحد يكمل المثل ~ {"..name.."}","md",true)  
end
end
if text and text:match("^بيع مجوهراتي (%d+)$") then
local NumGame = text:match("^بيع مجوهراتي (%d+)$") 
if tonumber(NumGame) == tonumber(0) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* 𓄼๏𓄹 لا استطيع البيع اقل من 1 *","md",true)  
end
local NumberGame = Redis:get(Timo.."Timo:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
if tonumber(NumberGame) == tonumber(0) then
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ليس لديك جواهر من الالعاب \n 𓄼๏𓄹 اذا كنت تريد ربح الجواهر \n 𓄼๏𓄹 ارسل الالعاب وابدأ اللعب ! ","md",true)  
end
if tonumber(NumGame) > tonumber(NumberGame) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n 𓄼๏𓄹 ليس لديك جواهر بهاذا العدد \n 𓄼๏𓄹 لزيادة مجوهراتك في اللعبه \n 𓄼๏𓄹 ارسل الالعاب وابدأ اللعب !","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم خصم *~ { "..NumGame.." }* من مجوهراتك \n 𓄼๏𓄹 وتم اضافة* ~ { "..(NumGame * 50).." } رساله الى رسالك *","md",true)  
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم اضافه له { "..text:match("^اضف مجوهرات (%d+)$").." } من المجوهرات").Reply,"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," 𓄼๏𓄹 تم اضافه له { "..text:match("^اضف رسائل (%d+)$").." } من الرسائل").Reply,"md",true)  
end
if text == "مجوهراتي" then 
local Num = Redis:get(Timo.."Timo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
return LuaTele.sendText(msg_chat_id,msg_id, " 𓄼๏𓄹 لم تفز بأي مجوهره ","md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id, " 𓄼๏𓄹 عدد الجواهر التي ربحتها *⇦ "..Num.." *","md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,[[*
 𓄼๏𓄹 تم ترتيب الاوامر بالشكل التالي •
- ايدي - ا •
- مميز - م •
- ادمن - اد •
- مدير - مد • 
...
local CmdStart = '*\n 𓄼🤖 أهلآ بك في بوت '..(Redis:get(Timo.."Timo:Name:Bot") or "سيلفا")..
'\n 𓄼⚙ اختصاص البوت حماية المجموعات'..
'\n 𓄼🛡 لتفعيل البوت عليك اتباع مايلي ...'..
'\n 𓄼⚜ اضف البوت الى مجموعتك'..
'\n 𓄼🔈 ارفعه ادمن {مشرف}'..
'\n 𓄼⛓ ارسل كلمة { تفعيل } ليتم تفعيل الجروب'..
'\n 𓄼🖇 مطور البوت = 𓄼 @'..UserSudo..' 𓄹*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼•تـيـمـو•𓄹', url = "https://t.me/tt_tt_4"},{text = '𓄼•سـيـزر•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•عـايز سـورس•𓄹', url = "https://t.me/tt_tt_4"}
},
{
{text = '𓄼•عـايـز بـوت•𓄹', url = "https://t.me/tt_tt_4"},{text = '𓄼•تـواصـل الـسـورس•𓄹', url = "https://t.me/TIMO8BOT"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 ارسل لي كليشه Start الان ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم حذف كليشه Start ","md",true)   
end
...
Redis:del(Timo.."Timo:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id," 𓄼๏𓄹 تم حذف اسم البوت ","md",true)   
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص 𓄼 '..Controller_Num(1)..' 𓄹* ',"md",true)  
...
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𓄼๏𓄹هاذا الامر يخص𓄼 '..Controller_Num(2)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(Timo.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𓄼๏𓄹عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:setex(Timo.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
𓄼๏𓄹 ارسل اذاعتك لنشرها في أعضاء خاص البوت 
...
return LuaTele.sendText(msg_chat_id,msg_id,"* 𓄼๏𓄹 تم حذف الردود العامه *","md",true)  
end
if text == '𓄼 مسح المطورين 𓄹' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* 𓄼๏𓄹 هاذا الامر يخص ?? '..Controller_Num(1)..' 𓄹* ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/SU_SELVA'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𓄼๏𓄹 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
...
LuaTele.sendText(IdSudo,0,Reply_Status(IdUser,' 𓄼๏𓄹 قام بارسال الملصق').Reply,"md",true)  
end
return LuaTele.sendText(IdUser,msg_id,Reply_Status(IdUser,' 𓄼๏𓄹 تم ارسال رسالتك الى المطور').Reply,"md",true)  
end
else 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' 𓄼๏𓄹 تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Timo..'Timo:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' 𓄼๏𓄹 تم الغاء حظره من تواصل البوت ').Reply,"md",true)  
end 
local ChatAction = LuaTele.sendChatAction(Info_User,'Typing')
if not Info_User or ChatAction.message == "USER_IS_BLOCKED" then
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' 𓄼๏𓄹 قام بحظر البوت لا استطيع ارسال رسالتك ').Reply,"md",true)  
end
if msg.content.video_note then
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' 𓄼๏𓄹 تم ارسال رسالتك اليه ').Reply,"md",true)  
end
end
end 
end --UserBot
...
return LuaTele.sendText(Sudo_Id,0,'*\n 𓄼๏𓄹 تم طرد البوت من مجموعه جديده \n 𓄼๏𓄹 اسم الجروب : '..Get_Chat.title..'\n 𓄼๏𓄹 ايدي الجروب :*`-100'..data.supergroup.id..'`\n 𓄼๏𓄹 تم مسح جميع البيانات المتعلقه بالجروب',"md")
end
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Timo..'Timo:Status:joinet'..data.message.chat_id) == 'true' then
    ...
    return LuaTele.sendText(data.message.chat_id, data.message.id, ' 𓄼๏𓄹 عليك اختيار انا لست بوت لتخطي نضام التحقق', 'md',false, false, false, false, reply_markup)
    end
...
if Text and Text:match('(%d+)/UnKed') then
    ...
    return LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 الامر لا يخصك", true)
    end
    LuaTele.setChatMemberStatus(ChatId,UserId,'restricted',{1,1,1,1,1,1,1,1})
    return LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 تم التحقق منك اجابتك صحيحه يمكنك الدردشه الان", 'md', false)
    end
...
return LuaTele.sendText(ChatId,Msg_id,'*𓄼๏𓄹 لا توجد صوره ف حسابك*',"md",true) 
end
end
end
...
MahibesText = '* 𓄼๏𓄹 الف مبروك حظك حلو اليوم\n 𓄼๏𓄹 فزت ويانه وطلعت المحيبس بل عظمه رقم𓄼'..NumMahibes..'𓄹*'
else
MahibesText = '* 𓄼๏𓄹 للاسف لقد خسرت المحيبس بالعظمه رقم 𓄼'..NumMahibes..'𓄹\n 𓄼๏𓄹 جرب حضك ويانه مره اخره*'
end
...
if tonumber(IdUser) == tonumber(UserId) then
LuaTele.editMessageText(ChatId,Msg_id,"*𓄼๏𓄹 تم رفض الزواج من الزوجه*","md",true) 
end
end
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𓄼๏𓄹 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
...
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الروابط").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكلايش").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكيبورد").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاغاني").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المتحركات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملفات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الدردشه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الفيديو").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصور").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المعرفات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التاك").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل البوتات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التوجيه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصوت").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملصقات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الجهات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الدخول").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاضافه").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل بصمه الفيديو").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التثبيت").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاشعارات").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الماركدون").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التعديل").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الالعاب").Lock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التكرار").Lock, 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الروابط").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكلايش").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكيبورد").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاغاني").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المتحركات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملفات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الفيديو").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصور").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المعرفات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التاك").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التوجيه").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصوت").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملصقات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الجهات").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل بصمه الفيديو").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الماركدون").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الالعاب").lockKid, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التكرار").lockKid, 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الروابط").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكلايش").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكيبورد").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاغاني").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المتحركات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملفات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الفيديو").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصور").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المعرفات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التاك").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التوجيه").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصوت").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملصقات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الجهات").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل بصمه الفيديو").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الماركدون").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الالعاب").lockKtm, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التكرار").lockKtm, 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الروابط").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكلايش").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الكيبورد").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الاغاني").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المتحركات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملفات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الفيديو").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصور").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل المعرفات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التاك").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التوجيه").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الصوت").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الملصقات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الجهات").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل بصمه الفيديو").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الماركدون").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل الالعاب").lockKick, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم قفـل التكرار").lockKick, 'md', true, false, reply_markup)
end
end
...
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الرابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الترحيب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الردود المضافه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم تعطيل ردود السورس *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الرفع").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الطرد - الحظر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تعطيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الرابط").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الترحيب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الايدي").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الايدي بالصوره").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الردود المضافه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الردود العامه").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم تفعيل ردود السورس *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الرفع").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الطرد - الحظر").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser," 𓄼๏𓄹 تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم ترقيه {"..y.."} ادمنيه \n 𓄼๏𓄹 تم ترقية المالك ", true)
end
end
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم فتح جميع الاوامر بنجاح ", true)
end
end
if Text and Text:match('/Zxchq(.*)') then
local UserId = Text:match('/Zxchq(.*)')
LuaTele.answerCallbackQuery(data.id, "𓄼๏𓄹 تم مغادره البوت من الجروب", true)
LuaTele.leaveChat(UserId)
end
if Text and Text:match('(%d+)/Redis') then
local UserId = Text:match('(%d+)/Redis')
LuaTele.answerCallbackQuery(data.id, "𓄼๏𓄹 تم الغاء الامر بنجاح", true)
if tonumber(IdUser) == tonumber(UserId) then
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه تغيير المعلومات", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,'【 ❌ 】',nil,nil,nil,nil,nil)
LuaTele.setChatMemberStatus(ChatId,UserId[2],'administrator',{0 ,0, 0, 0, 0,0,0,1,0})
else
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه تغيير المعلومات", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,'【 ✅ 】',nil,nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'【 ❌ 】',nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه التثبيت", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,'【 ✅ 】',nil,nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'【 ❌ 】',nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه الحظر", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,'【 ✅ 】',nil,nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'【 ❌ 】',nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه دعوه المستخدمين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,'【 ✅ 】',nil,nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'【 ❌ 】',nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه مسح الرسائل", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,'【 ✅ 】',nil)
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تعطيل صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'【 ❌ 】')
...
LuaTele.answerCallbackQuery(data.id, " 𓄼๏𓄹 تم تفعيل صلاحيه اضافه مشرفين", true)
GetAdminsSlahe(ChatId,UserId[1],UserId[2],Msg_id,nil,nil,nil,nil,nil,'【 ✅ 】')
...
{
{text = '𓄼๏𓄹 القائمه الرئيسيه 𓄼๏𓄹', data = IdUser..'/helpall'},
},
{
{text = '𓄼๏𓄹 اخفاء الاوامر 𓄼๏𓄹', data =IdUser..'/'.. 'delAmr'}
},
}
}
return LuaTele.editMessageText(ChatId,Msg_id,' 𓄼๏𓄹 اوامر التفعيل والتعطيل ', 'md', false, false, reply_markup)
end
end
...
return LuaTele.editMessageText(ChatId,Msg_id,'* 𓄼๏𓄹 اوامر حماية الجروب *', 'md', false, false, reply_markup)
end
end
...
{
{text = '𓄼๏𓄹 القائمه الثانيه 𓄼๏𓄹', data =IdUser..'/'.. 'NextSeting'}
},
{
{text = '𓄼๏𓄹 القائمه الرئيسيه 𓄼๏𓄹', data = IdUser..'/helpall'},
},
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الروابط", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الكلايش", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الكيبورد", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الاغاني", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر المتحركات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الملفات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الدردشه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الفيديو", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الصور", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر المعرفات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر التاك", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر البوتات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر التوجيه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الصوت", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الملصقات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الجهات", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الدخول", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الاضافه", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر بصمه الفيديو *", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر التثبيت *", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الاشعارات *", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الماركدون *", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر التعديل", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id," 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر الالعاب", 'md', true, false, reply_markup)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 عليك اختيار نوع القفل او الفتح على امر التكرار *", 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الروابط *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الكلايش *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الكيبورد *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الاغاني *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح المتحركات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الملفات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الدردشه *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الفيديو *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الصور *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح المعرفات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح التاك *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح البوتات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح التوجيه *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الصوت *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الملصقات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الجهات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الدخول *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الاضافه *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح بصمه الفيديو *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح التثبيت *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الاشعارات *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الماركدون *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح التعديل *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح الالعاب *").unLock, 'md', true, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* 𓄼๏𓄹 تم فتح التكرار *").unLock, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح مطورين البوت *", 'md', false)
end
elseif Text and Text:match('(%d+)/DevelopersQ') then
local UserId = Text:match('(%d+)/DevelopersQ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح مطورين الثانوين من البوت *", 'md', false)
end
elseif Text and Text:match('(%d+)/TheBasics') then
local UserId = Text:match('(%d+)/TheBasics')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:TheBasics:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المنشئين الاساسيين *", 'md', false)
end
...
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المالكين *", 'md', false)
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المميزين *", 'md', false)
end
elseif Text and Text:match('(%d+)/Redisa') then
local UserId = Text:match('(%d+)/Redisa')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:Redisa:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المحظورين عام *", 'md', false)
end
elseif Text and Text:match('(%d+)/ktmAll') then
local UserId = Text:match('(%d+)/ktmAll')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:ktmAll:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المكتومين عام *", 'md', false)
end
elseif Text and Text:match('(%d+)/BanGroup') then
local UserId = Text:match('(%d+)/BanGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Timo.."Timo:SilentGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* 𓄼๏𓄹 تم مسح المكتومين *", 'md', false)
end
end
end
end
