...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/Timo'}, },}}
...
{
{text = Jabwa, url = 't.me/Timo'}, 
},
{
{text = Grosupsw, url = 't.me/Timo'}, 
},
{
{text = Usperos, url = 't.me/Timo'}, 
},
}
